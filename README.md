...
- Summary: overview of key metrics such as total revenue, profit, total orders, and returns over selected time periods. 
    ...
    - Top 20 Products: A ranked list of the top 20 products based on sales, highlighting bestsellers and key revenue drivers.

- Product Details: Provides an in-depth look at specific categories or products
    - KPIs: Monthly actual vs. target for orders, revenue, and profit
    - Profit Analysis: Total and adjusted profit based on product price adjustment slicer
    - Metric selection: Track over time results for Orders, Revenue, Profit, Returns and Rerurn %)
- Customers:  Analyzes customer purchasing behavior and identifies top customers
    - Over Time overview: Total orders and revenue per customer
    - Customers destibution: Total orders, Revenue and AVG. Revenue per customer per city 
    - Top 100 customers: A ranked list of the top 100 customers based on the number of orders and revenue
